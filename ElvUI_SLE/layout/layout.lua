...
function LO:ToggleChatPanels()
	...
	if E.db.chat.panelBackdrop == 'SHOWBOTH' then
		...
		LeftChatDataPanel:Point('TOPRIGHT', LeftChatPanel, 'BOTTOMLEFT', 16 + E.db.sle.datatext.chatleft.width, (E.PixelMode and 0 or -1)) --upper line of datapanel		
		...
		RightChatDataPanel:Point('TOPRIGHT', RightChatPanel, 'BOTTOMRIGHT', -SIDE_BUTTON_WIDTH, (E.PixelMode and 0 or -1))	--upper-right corner of right datapanel	
