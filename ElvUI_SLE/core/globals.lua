...
SLE.rolePaths = {
	['ElvUI'] = {
		TANK = [[Interface\AddOns\ElvUI\Game\Shared\Media\Textures\Tank]],
		HEALER = [[Interface\AddOns\ElvUI\Game\Shared\Media\Textures\Healer]],
		DAMAGER = [[Interface\AddOns\ElvUI\Game\Shared\Media\Textures\DPS]]
	},
	['SupervillainUI'] = {
