			...
			raids = {
				...
				args = {
					...
					MoP = {
						...
						args = {
							mv = { order = 1, type = "toggle", name = SLE:GetMapInfo(896, "name") },
							hof = { order = 2, type = "toggle", name = SLE:GetMapInfo(897, "name") },
							toes = { order = 3, type = "toggle", name = SLE:GetMapInfo(728, "name") },
					...
					WoD = {
						...
						args = {
							...
							hfc = { order = 3, type = "toggle", name = SLE:GetMapInfo(660, "name") },
						},
					},
					Legion = {
						order = 4, type = "group",
						name = EXPANSION_NAME6..EXPANSION_NAME7,
						guiInline = true,
						...
						args = {
							...
							palace = { order = 3, type = "toggle", name = SLE:GetMapInfo(761, "name") },
