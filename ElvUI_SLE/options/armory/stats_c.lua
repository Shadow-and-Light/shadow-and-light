...
local function configTable()
	...
	ItemLevel.useBlizzColor = ACH:Toggle(L["Use Blizzards Color"], L["This will color the text based on what blizzard would normally use."], 3, nil, nil, nil, nilget, nilset, function() return SLE._Compatibility['DejaCharacterStats'] or not E.db.sle.armory.stats.itemLevel.enable or not E.private.sle.armory.stats.enable end)
