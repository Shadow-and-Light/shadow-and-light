	...
	["minimap"] = {
		...
		["locPanel"] = {
			...
			["portals"] = {
				...
				["hsPrio"] = "54452,64488,93672,142542,162973,163045,165669,165670,165802,166746,166747,168907,172179,182773,183716,180290,184353,188952,190237,208704,209035",
				["showToys"] = true,
				["showSpells"] = true,
				["showEngineer"] = true,
			},
