...
function SUF:Construct_FocusTargetFrame(frame)
	-- print('Construct_FocusTargetFrame: ', frame:GetName())
...
function SUF:Update_FocusTargetFrame(frame)
	-- print('Update_FocusTargetFrame: ', frame:GetName())
