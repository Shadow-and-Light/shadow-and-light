...
local function OnEnter(self)
	...
	local Ordo = IsQuestFlaggedCompleted(33118)
	...
	DT.tooltip:AddDoubleLine(L['Celestials']..':', Nalak and "\124cffff0000"..L['Defeated'].."\124r" or "\124cff00ff00"..L['Undefeated'].."\124r", 1, 1, 1, 0.8, 0.8, 0.8)
	DT.tooltip:AddDoubleLine(L['Ordo']..':', Nalak and "\124cffff0000"..L['Defeated'].."\124r" or "\124cff00ff00"..L['Undefeated'].."\124r", 1, 1, 1, 0.8, 0.8, 0.8)
