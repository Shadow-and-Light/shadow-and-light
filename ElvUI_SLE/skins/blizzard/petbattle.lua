...
local function PetBattle()
	...
	f.ActiveAlly.Icon:SetPoint("BOTTOMLEFT", a, "BOTTOMLEFT", 0, 0)
	f.ActiveEnemy.Icon:SetPoint("BOTTOMRIGHT", a, "BOTTOMRIGHT", 0, 0)
	f.AllyBuffFrame:SetPoint("TOPLEFT", f.ActiveAlly.Icon, "BOTTOMLEFT", 0, -5)
	f.AllyPadBuffFrame:ClearAllPoints()
	f.AllyPadBuffFrame:SetPoint("TOPLEFT", f.AllyBuffFrame, "TOPRIGHT", 2, 0)
	f.EnemyBuffFrame:SetPoint("TOPRIGHT", f.ActiveEnemy.Icon, "BOTTOMRIGHT", 0, -5)
	f.EnemyPadBuffFrame:ClearAllPoints()
	f.EnemyPadBuffFrame:SetPoint("TOPRIGHT", f.EnemyBuffFrame, "TOPLEFT", -2, 0)
