...
L["Choose what icon set will unitframes and chat use."] = "Wähle aus, welche Symbole für Einheitenfenster und Chat verwendet werden sollen."
L["Class"] = "Klasse"
...
L["Color code item levels values. Equipped will be gradient, average - selected color."] = "Farbcode Gegenstandsstufen Werte. Ausgerüstet ist ein Farbverlauf, Durschnitt - gewählte Farbe."
...
L["Darth's Default Set"] = "Darth's Standard Einstellungen"
L["Date"] = "Datum Schriftart"
...
L["ElvUI Objective Tracker"] = "ElvUI Zielverfolgung"
L["ElvUI Skins"] = true
...
L["Enables a shadow for the panel or backdrop of this frame."] = "Aktiviert einen Schatten für das Panel oder den Hintergrund dieses Fensters."
...
L["Enabling mouse over will make ElvUI's raid utility show on mouse over instead of always showing."] = "Durch Aktivieren der Maus wird das Schlachtzugs Dienstprogramm von ElvUI an der Maus angezeigt, anstatt immer angezeigt zu werden."
...
L["Faction Crest X-Offset"] = "Fraktionswappen X-Versatz"
L["Faction Crest Y-Offset"] = "Fraktionswappen Y-Versatz"
