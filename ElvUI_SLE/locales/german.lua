...
L["Armor Set Gradient Texture Color"] = "Rüstungsset Textur Verlaufsfarbe"
L["As List"] = "AS Liste"
...
L["FAQ_Elv_1"] = "|cff30ee30Q: Wo kann ich ElvUI-Unterstützung erhalten??|r\n|cff9482c9A:|r Der beste Weg wäre das offizielle Forum - https://www.tukui.org/forum/\nUm einen Fehler zu melden, kannst Du den Issue Tracker verwenden https://git.tukui.org/elvui/elvui/issues"
L["FAQ_Elv_2"] = "|cff30ee30Q: Muss ich dafür gut Englisch können??|r\n|cff9482c9A:|r Englisch ist die offizielle Sprache der tukui.org-Foren, daher sind die meisten Beiträge dort auf Englisch.\nDies bedeutet jedoch nicht, dass es die einzige Sprache ist, die dort verwendet wird. Du findest Beiträge in Spanisch, Französisch, Deutsch, Russisch, Italienisch, etc.\nSolange Sie einige einfache Regeln des gesunden Menschenverstands befolgen können, wie z. B. die Angabe der Sprache im Titel des Themas, ist jeder damit einverstanden, dass Du in Deiner Muttersprache postest.\nDenke daran, dass Du möglicherweise trotzdem eine Antwort auf Englisch erhälst, da die Person, die Dir antwortet, Deine Sprache möglicherweise nicht spricht."
...
L["FAQ_sle_5"] = "|cff30ee30Q: Wie kann ich mit euch in Kontakt treten??|r\n|cff9482c9A:|r Aus naheliegenden Gründen geben wir unsere Kontaktdaten nicht freiwillig heraus. Am besten nutzt Du also die tukui.org-Foren oder sogar unseren Discord."
L["Farm"] = true
...
L["Raid Utility Mouse Over"] = "Schlachtzugs Werkzeug Mouse Over"
L["RAID_ANTO"] = "Antorus"
L["RAID_DAZALOR"] = "BfDA"
L["RAID_EN"] = "EN"
...
L["Sets the color of average item level."] = "Legt die Farbe vom Durchschnitts Gegenstandlevel fest"
