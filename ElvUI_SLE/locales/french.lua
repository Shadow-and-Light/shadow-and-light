...
L["%sLeft Click|r datatext panel to open friends list."] = "%sClic gauche|r sur le panneau de texte de données pour ouvrir la liste d'amis."
L["%sLeft Click|r datatext panel to open guild list."] = "%sClic gauche|r sur le panneau de texte de données pour ouvrir la liste de la guilde."
...
L["%sRight Click|r datatext panel to customize."] = "%sClic droit|r sur le panneau de texte de données pour personnaliser."
...
L["%sShift+Right Click|r a person's line to set a note for them."] = "%sShift+Clic droit|r sur la ligne d'une personne pour définir une note pour elle."
L["|cff9482c9Shadow & Light|r Installation"] = "|cff9482c9Installation de Shadow & Light|r"
L["About"] = "À propos de"
L["About/Help"] = "A propos/Aide"
L["Account Time Played"] = "Le temps joué sur le compte :"
L["Actionbar Autocast"] = "Activation automatique de la barre d'actions"
L["Actionbar Proc"] = "Activation de la barre d'actions"
...
L["AFK Message & Time"] = "Message et durée d'AFK"
...
L["Armor Set Gradient Texture Color"] = "Couleur de la texture de dégradé de l'ensemble d'armure"
...
L["Auto Work Orders for Shipyard"] = "Commandes de travail automatiques pour le chantier naval"
L["Auto Work Orders for Trading Post"] = "Commandes de travail automatiques pour le comptoir commercial"
L["Auto Work Orders for Warmill"] = "Commandes de travail automatiques pour la fonderie"
...
L["Automatically plant seeds to the nearest tilled soil if one is not already selected."] = "Planter automatiquement des graines dans le sol labouré le plus proche si aucun n'est déjà sélectionné."
L["Automatically queue maximum number of work orders available for Shipyard."] = "Ajouter automatiquement le nombre maximum de commandes de travail disponibles pour le chantier naval."
L["Automatically queue maximum number of work orders available for Trading Post."] = "Ajouter automatiquement le nombre maximum de commandes de travail disponibles pour le comptoir commercial."
L["Automatically queue maximum number of work orders available for Warmill/Dwarven Bunker."] = "Ajouter automatiquement le nombre maximum de commandes de travail disponibles pour la fonderie/la caserne naine."
L["Automatically queue maximum number of work orders available when visiting respected NPC."] = "Ajouter automatiquement le nombre maximum de commandes de travail disponibles lors de la visite d'un PNJ respecté."
...
L["Change the position from where seed bars will grow."] = "Changez la position à partir de laquelle les barres de graines pousseront."
...
L["Check for rebirth mechanics"] = "Vérifier les mécanismes de résurrection"
...
L["Coords Location"] = "Emplacement des coordonnées"
...
L["Crest"] = "Wappen"
L["Custom roll limits are set incorrectly! Minimum should be smaller than or equal to maximum."] = "Les limites de lancer personnalisées sont définies de manière incorrecte ! Le minimum doit être inférieur ou égal au maximum."
...
L["Deconstruction mode will ignore BoA weapons from Pandaria."] = "Le mode de déconstruction ignorera les armes liées au compte de Pandarie."
L["Deconstruction mode will ignore cooking specific items."] = "Le mode de déconstruction ignorera les objets spécifiques à la cuisine."
...
L["Dedicated Vehicle Bar"] = "Barre de véhicule dédiée"
...
L["Display Quality"] = "Afficher la qualité"
...
L["Enables a shadow for the panel or backdrop of this frame."] = "Active une ombre pour le panneau ou le fond de cette fenêtre."
L["Enables a shadow on the %s when it's enabled."] = "Active une ombre sur le %s lorsqu'il est activé."
L["Enables a small arrow-like indicator on the item slot. Howering over this arrow will show the item this slot is transmogged into."] = "Active un indicateur en forme de petite flèche sur l'emplacement de l'objet. En survolant cette flèche, l'objet vers lequel cet emplacement est transmogrifié sera affiché."
L["Enables an indicator on equipment icons located in your bags to show if they are part of an equipment set."] = "Active un indicateur sur les icônes d'équipement situées dans vos sacs pour montrer s'ils font partie d'un ensemble d'équipement."
L["Enables timers for 2 & 3 chest times in M+"] = "Active des chronomètres pour les temps à 2 et 3 coffres en donjons mythiques +".
...
L["Frame 8"] = "Fenêtre 8"
L["Frame 9"] = "Fenêtre 9"
L["From Mount"] = "Depuis la monture"
...
L["Garrison Tools Bar"] = "Barre des outils de la garnison"
...
L["Hide In Class Hall"] = "Masquer dans le hall de classe"
L["Hide in Pet Battle"] = "Masquer dans le combat de mascotte"
L["Hide minimap in combat."] = "Cacher la minimap au combat."
L["Hide Minimap Mail Icon"] = "Masquer l'icône du courrier de la minicarte"
...
L["Inverse Anchor Points"] = "Points d'ancrage inversés"
L["Invite Keywords"] = "Mots-clés pour l'invitation"
L["Invite links"] = "Lien d'invitation"
L["Item Info Font"] = "Police d'informations sur l'objet"
...
L["KB Sound"] = true
L["Key Timers"] = "Chronomètres des clés"
...
L["Legacy Shadows"] = "Ombres héritées"
...
L["Maximum Roll Value"] = "Valeur maximale du lancer"
L["Message"] = true
...
L["Music Selection"] = "Sélection de musique"
...
L["Patrons"] = "Mécènes"
L["Pet Battle AB"] = "Bataille de mascottes AB"
L["Pet Battle Status"] = "Statut de la bataille de mascottes"
L["Pet Battles skinning"] = "Habillage des combats de mascottes"
L["Play sound when killing blows popup is shown."] = "Jouer un son lorsque la fenêtre des coups fatals s'affiche."
...
L["Quest Log Toggle"] = "Basculer le journal des quêtes"
...
L["RAID_TOS"] = "ToS"
L["RAID_TOV"] = "ToV"
L["Random Tips"] = "Conseils aléatoires"
L["Random Tips Scroll Frame"] = "Cadre de défilement des conseils aléatoires"
...
L["Show Both Timers"] = "Afficher les deux chronomètres"
...
L["Show Dragon Flying"] = "Afficher le vol du dragon"
...
L["Show goal time markers on the timer bar"] = "Afficher les marqueurs de temps de l'objectif sur la barre de chronométrage"
...
L["Show Marks"] = "Afficher les marques"
...
L["Show timers for both milestones at the same time if available."] = "Affiche les chronomètres pour les deux jalons en même temps s'ils sont disponibles."
...
L["Strict String Replacement"] = "Remplacement de chaîne strict"
...
L["The higher limit for custom roll button."] = "La limite supérieure pour le bouton de lancer personnalisé."
L["The lower limit for custom roll button."] = "La limite inférieure pour le bouton de lancer personnalisé."
...
L["Tip time"] = "Durée des conseils"
L["Tips font"] = "Police des conseils"
L["Title font"] = "Police de titre"
L["Title Width"] = "Largeur du titre"
L["Title"] = "Titre"
L["Toolbar"] = "Barre d'outils"
L["Top Offset"] = "Décalage supérieur"
L["Torghast Powers"] = "Pouvoirs de Tourgast"
L["Torghast Powers Bar that contains your powers in the objective tracker will have the ElvUI look."] = "La barre des pouvoirs de Tourgast qui contient vos pouvoirs dans le suivi des objectifs aura l'apparence d'ElvUI."
L["Tracked"] = "Suivi"
L["Transmog"] = 'Transmo'
...
L["Update Throttle"] = "Fréquence de mise à jour"
...
L["Viewport"] = "Zone de visualisation"
L["Warning Bar Color"] = "Couleur de la barre d'avertissement"
L["Warning Gradient Texture Color"] = "Couleur de la texture de dégradé d'avertissement"
