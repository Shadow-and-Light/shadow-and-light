...
L["SLE_TIPS"] = {
	...
	"На форумах tukui.org поддержка оказывается в том числе и на русском языке.",
...
|cff9482c9О:|r В принципе это не имеет значения. Официально поддержка по Shadow & Light оказывется на английском и русском языках.
Но сообщество tukui.org довольно велико, и в нем есть люди, говорящие на многих языках. В крайнем случае мы можем попросить их помочь с переводом.]]
...
L["FAQ_5"] = [[|cff30ee30В: Как я могу связаться с авторами?|r
