...
L["CHANGE_LOG"] = [=[|cff1784d1v1.3|r (27 ноября, 2012)
...
- Добавлен альтернативный инфо-текст дла восполнения маны. Заголовок на нем показывается в виде "MP5", а не "Восполнение маны"
