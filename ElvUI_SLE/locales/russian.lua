...
L["AFK Message & Time"] = "AFK Сообщение и время"
...
L["Dedicated Vehicle Bar"] = "Выделенная панель для транспорта"
...
L["Display Quality"] = "Качество отображения"
...
L["Enables a dedicated vehicle bar."] = "Включает панель транспортных средств."
L["Enables a shadow for the panel or backdrop of this frame."] = "Включает тень для панели или фона этой рамки."
...
L["Enables an indicator on equipment icons located in your bags to show if they are part of an equipment set."] = "Включает индикатор на значках снаряжения, расположенных в сумках, чтобы показать, являются ли они частью комплекта снаряжения."
...
L["FAQ_Elv_1"] = "|cff30ee30В: Где я могу получить поддержку ElvUI?|r\n|cff9482c9О:|r Лучшим способом будет дискорд-сервер сообщества Tukui - https://discord.gg/xFWcfgE\nЧтобы сообщить об ошибке, вы можете использовать трекер проблем, расположенный по адресу https://github.com/tukui-org/ElvUI/issues."
L["FAQ_Elv_2"] = "|cff30ee30В: Нужно ли мне знать хорошо английский язык для этого?|r\n|cff9482c9О:|r Английский является официальным языком сообщества tukui.org, поэтому большинство сообщений будет на английском.\nЭто не означает, что это единственный язык, используемый в сообществе. Вы можете найти сообщения на испанском, французском, немецком, русском, итальянском и т.д.\nЕсли вы будете следовать некоторым простым правилам здравого смысла, например, указывать язык в названии темы, все будут согласны с тем, что вы пишете на своем родном языке.\nНе забывайте, что вы все равно можете получить ответ на английском, так как человек, отвечающий вам, может не владеть вашим языком."
...
L["Inverse Anchor Points"] = "Перевернутые якорные точки"
...
L["Legacy Shadows"] = "Наследуемые тени"
...
L["Misc"] = "Прочее"
L["Missing scroll item for spellID %d. Please report this at the Shadow&Light Ticket Tracker."] = "Отсутствует элемент прокрутки для spellID %d. Пожалуйста, сообщите об этом в систему отслеживания тикетов Shadow&Light."
L["Mode"] = "Режим"
...
L["Music Selection"] = "Выбор музыки"
...
L["Random Tips Scroll Frame"] = "Рамка с прокруткой для случайных советов"
...
L["Show Dragon Flying"] = "Показать полёт дракона"
...
L["Strict String Replacement"] = "Строгая замена строк"
...
L["Tier Set"] = "Уровневый комплект"
L["Tier Set Gradient Color"] = "Цвет уровневого комплекта"
...
L["Torghast Powers Bar that contains your powers in the objective tracker will have the ElvUI look."] = "Панель способностей Торгаста, содержащая ваши способности в трекере целей, будет иметь вид ElvUI."
L["Tracked"] = "Отслеживание"
L["Transmog"] = "Трансмог"
L["Tries to place a shadow around the health, power, and classbars as one frame instead of individual frames."] = "Попытаться поместить тень вокруг панелей здоровья, силы и классов как один фрейм вместо отдельных фреймов."
...
L["Viewport"] = "Окно просмотра"
L["Warning Bar Color"] = "Цвет полосы предупреждения"
L["Warning Gradient Texture Color"] = "Цвет градиента текстуры предупреждения"
