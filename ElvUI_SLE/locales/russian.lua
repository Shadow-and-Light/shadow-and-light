...
L["Fade"] = "Появление"
L["FAQ_DESC"] = "Эта секция содержит некоторые вопросы об ElvUI и Shadow & Light."
L["FAQ_Elv_1"] = "|cff30ee30В: Где я могу получить поддержку по ElvUI?|r\n|cff9482c9О:|r Лучше всего на официальном форуме - https://www.tukui.org/forum/\nДля сообщений об ошибках лучше использовать тикет-треккер - https://git.tukui.org/elvui/elvui/issues"
