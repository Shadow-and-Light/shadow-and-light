...
Например: |TInterface\AddOns\ElvUI_SLE\media\textures\SLE_Chat_Logo:14:14|t это иконка для разработчиков, а |TInterface\AddOns\ElvUI_SLE\media\textures\SLE_Chat_Logo_Alt:14:14|t это иконка, которую иногда использует Repooc. |TInterface\AddOns\ElvUI_SLE\media\textures\Chat_Test:16:16|t для людей, котрые в свое время помогли вычислить хитрый баг.]]
