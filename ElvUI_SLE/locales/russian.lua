...
L["Adjust the tooltip autohide delay when mouse is no longer hovering of the datatext."] = "Устанавливает время исчезновения подсказки после ухода курсора с инфотекста."
...
L["Changes the text string to a shorter variant."] = "Заменяет текст на инфотексте более коротким вариантом."
...
L["Don't show this panel, only datatexts assigned to it."] = "Не показывать саму панель, а только назначенные на нее инфотексты"
...
L["Enables a dedicated vehicle bar."] = "Включает специальную панель транспортного средства"
L["Enables a shadow for the panel or backdrop of this frame."] = "Включает тень для панели или фона этого кадра"
L["Enables a shadow on the %s when it's enabled."] = "Включает тень на %s, когда она включена"
...
L["Enables an indicator on equipment icons located in your bags to show if they are part of an equipment set."] = "Включает индикатор на значках снаряжений, расположенных в ваших сумках, чтобы показать, являются ли они частью набора экипировки"
...
L["Hide the hints in the tooltip."] = "Скрывать инструкцию по управлению в подсказке инфотекста."
...
L["Legacy Shadows"] = "Унаследованные тени"
...
L["Misc"] = "Прочее"
L["Missing scroll item for spellID %d. Please report this at the Shadow&Light Ticket Tracker."] = "Отсутствует элемент прокрутки для ID заклинания %d. Сообщите об этом в тикет-трекер Shadow&Light."
L["Mode"] = "Режим"
...
L["Options below are for standard ElvUI's durability datatext."] = "Опции ниже предназначены для стандартного инфотекста прочности."
...
L["S&L Datatexts"] = "Инфотексты S&L"
...
L["Show total friends in the datatext."] = "Показывать общее кол-во друзей на инфотексте."
L["Show total guild members in the datatext."] = "Показывать общее кол-во членов гильдии на инфотексте."
...
L["Show/Hide LFR lockout info in time datatext's tooltip."] = "Отображать/скрывать информацию о сохранении ЛФР в инфотексте времени"
...
L["SLE_DT_CURRENCY_WARNING_GOLD"] = [[На вашей панели %s включен инфотекст |cff3cbf27"Золото"|r при активном инфотексте |cff3cbf27"S&L Currency"|r. Для корректной работы |cff3cbf27"S&L Currency"|r мы отключаем некоторые функции инфотекста |cff3cbf27"Золото"|r. Для избежания данного конфликта вам необходимо заменить один из конфликтующих инфотекстов.]]
...
L["Some datatexts that Shadow & Light are supplied with, has settings that can be modified to alter the displayed information."] = "Некоторые инфотексты, предоставляемые Shadow & LIght, имеют настройки, изменяющие отображаемую информацию."
...
L["Strict String Replacement"] = "Точная замена строки"
...
L["These options are for modifying the Shadow & Light Friends datatext."] = "Опции для настройки инфотекста S&L Friends."
L["These options are for modifying the Shadow & Light Guild datatext."] = "Опции для настройки инфотекста S&L Guild."
...
L["Transmog"] = "Трансмог"
L["Tries to place a shadow around the health, power, and classbars as one frame instead of individual frames."] = "Пытается разместить тень вокруг панелей здоровья, мощности и панели классов в виде одного кадра, а не отдельных кадров."
...
L["Will not show the tooltip while in combat."] = "Не отображать подсказки инфотекста в бою."
