...
L["No LFR is available for your lever/gear."] = "Нет ЛФР под ваш уровень/экиперовку"
...
L["CHANGE_LOG"] = [=[
|cff1784d1v1.37|r
- Текст здоровья/ресурса вновь показывает десятые доли процентов

|cff1784d1v1.36|r
- Внутренние изменения для лучшей работы с ElvUI 5.20

|cff1784d1v1.35|r
- Исправлена ошибка совместимости с Location Plus

|cff1784d1v1.34|r
- Исправлена ошибка при использовании смещения полос класса у рыцарей смерти

|cff1784d1v1.33|r
- Исправлены ошибки при отображении подсказок к аурам
- Высота полос здоровья при включенном смещении полос класса теперь не будет наметно ниже положеной

|cff1784d1v1.32|r
- Настройки обновлены

|cff1784d1v1.31|r
- Обновлены установки Repooc'а (на этот раз правда)
